...
def _to_out(e: JournalEntry, trade: Optional[Trade] = None) -> JournalEntryOut:
    return JournalEntryOut(
        ...
        mfe_pnl=float(trade.mfe_pnl) if (trade and trade.mfe_pnl is not None) else None,
        mae_pnl=float(trade.mae_pnl) if (trade and trade.mae_pnl is not None) else None,
        pnl_capture_pct=float(trade.pnl_capture_pct) if (trade and trade.pnl_capture_pct is not None) else None,

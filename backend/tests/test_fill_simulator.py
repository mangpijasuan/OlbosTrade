...
class TestFillSimulator:
    ...
    def test_spread_fill_returns_one_result_per_leg(self):
        ...
        result = simulator.simulate_spread_fill(legs, contracts=1, simulate_partial_fills=False)
    ...
    def test_iron_condor_four_legs(self):
        ...
        result = simulator.simulate_spread_fill(legs, contracts=2, simulate_partial_fills=False)
